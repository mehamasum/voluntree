...
from voluntree.views import WebhookCallbackView, SetupWebhookCallbackView, get_name, get_done
...
urlpatterns = [
    ...
    path('messenger/<page_id>/signup/<int:signup_id>/<ps_id>/', get_name),
    path('messenger/signup/done/', get_done),
]
